...
func Test_CCC_C08_TR02_T01_succeeds(t *testing.T) {
	// Arrange
	myMock := storageAccountMock{
...
func Test_CCC_C08_TR02_T01_fails_secondary_status_is_nil(t *testing.T) {
	// Arrange
	myMock := storageAccountMock{
...
func Test_CCC_C08_TR02_T01_fails_secondary_status_is_not_available(t *testing.T) {
	// Arrange
	myMock := storageAccountMock{
...
func Test_CCC_C08_TR02_T02_succeeds(t *testing.T) {
	// Arrange
	myMock := storageAccountMock{
...
func Test_CCC_C08_TR02_T02_fails_last_sync_nil(t *testing.T) {
	// Arrange
	myMock := storageAccountMock{
		LastSyncTime: nil,
	}
...
func Test_CCC_C08_TR02_T02_fails_last_sync_30mins_ago(t *testing.T) {
	// Arrange
	myMock := storageAccountMock{
